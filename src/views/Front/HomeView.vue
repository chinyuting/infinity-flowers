<template>
  ...
  <div class="home">
    ...
    <div class="mt-5 container-fluid">
      ...
      <div class="row">
        <div class="col-md-6 align-middle" style="color:rgba(231, 152, 152, 1);">
          <h3 class="fst-italic slogan text-center m-auto">
            乾燥花是時間的見證<br>它記錄了花的美麗瞬間<br>留下了永恆的回憶。
...
.homepic{
  border-radius: 46% 54% 30% 70% / 53% 43% 57% 47%;
  width: 88%;
}
.slogan{
  width: 290px;
...
@media only screen and (max-width: 768px){
  ...
  .slogan{
    /* color: white; */
    text-shadow: rgba(231, 152, 152, 1) 0.1em 0.1em 0.2em;
    color: white;
    position: absolute;
    z-index: 5;
    padding-top: 10px;
